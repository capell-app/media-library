...
![Media health page](screenshots/media-health-page.png)

- Surface: admin · Target: MediaHealthPage.
- Documents: An administrator reviews media health status for stale, missing, or incomplete assets.
- Capture notes: Capture after installing capell-app/media-library in the isolated demo harness and seeding the data required for this use case.

### Media health table

![Media health table](screenshots/media-health-table.png)

- Surface: admin · Target: MediaHealthTable.
- Documents: An administrator scans individual media health rows and remediation state.
- Capture notes: Capture the table inside MediaHealthPage after installing capell-app/media-library in the isolated demo harness and seeding missing-alt, stale, and unused Curator records.

### Curator media field inside a form

![Curator media field inside a form](screenshots/curator-media-field-inside-a-form.png)

- Surface: admin · Target: CuratorMediaFieldFactory.
- Documents: An editor selects media through the Curator field embedded in a Capell form.
- Capture notes: Capture a host Capell form that resolves Capell\Core\Contracts\Media\MediaFieldFactory to CuratorMediaFieldFactory and renders Awcodes CuratorPicker for a media FK column.

### Migration command output or report

![Migration command output or report](screenshots/migration-command-output-or-report.png)

- Surface: console · Target: capell:media-migrate-to-curator.
- Documents: A developer reviews the Spatie-to-Curator migration report before or after migration.
- Capture notes: Run the migration command with a seeded Spatie media fixture, preferably first with --dry-run, and capture the summary table and warning output.
